...
Back-end developer based in São Paulo, Brazil, building APIs and services with **TypeScript** and **Python**, with a strong interest in **law tech** products and clean, maintainable code.

- 🐍 Building back-end systems with **TypeScript** and **Python**
- 💻 Currently exploring the **Bun** runtime
- 🧠 I'm a **[Boot.dev](https://www.boot.dev/u/thegabcastro)** Archmage (learning back-end the hard way, by coding)
...
<div align="left">
  ...
  <p><strong>Languages, Libraries & Frameworks</strong><br>
  ...
  <p><strong>Runtimes</strong><br>
    ...
    <img alt="Bun" title="Bun" width="30px" style="padding-right: 10px;" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/bun/bun-original.svg" />
  </p>
